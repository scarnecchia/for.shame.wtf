...
import type { AppBskyActorDefs, ComAtprotoServerGetSession, Records, ToolsOzoneModerationDefs } from "@atcute/client/lexicons";
...
export declare class Bot extends EventEmitter {
     ...
     */
    login({ identifier, password }: BotLoginOptions): Promise<AtpSessionData>;
    /**
